...
def build_training_features(
    ...
    *,
    ...
    for target_local_date in pd.date_range(start_date, end_date, freq="D").date:
        ...
        for model in model_list:
            forecast = fetcher(model, init_run_utc.to_pydatetime(), forecast_hours, station.lat, station.lon, ["TMP:2 m", "APCP:surface"])
